...
- **Small.** Between 363 and 881 bytes (minified and brotlied).
...
- [qs](https://github.com/VdustR/nanostores-qs) manages the query string
  in the URL.
- [Form](https://github.com/alexcarpenter/form) for headless forms.
